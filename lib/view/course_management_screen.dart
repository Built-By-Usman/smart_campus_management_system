...
import 'package:smar_campus_management_system/controller/course_management_screen_controller.dart';
...
class CourseManagementScreen extends StatelessWidget {
  ...
  final CourseManagementScreenController controller = Get.put(
    (CourseManagementScreenController()),
  );
